...
# CD4 proliferating, CD8 Naive and dnT no longer a part of this list due to low cell number
...
# ------------------------------------------------------------------------------
# 2. Perform DE analysis of AD vs HC for all clonal T cells by genotype
# ------------------------------------------------------------------------------
# APOE genotype E3/E3
...
# ------------------------------------------------------------------------------
# Redefine T cell clusters which have enough cells for DE analysis
# CD4 proliferating, CD8 Naive, and dnT no longer a part of this list due to low cell number
t_cell_clusters <-c("CD4 CTL",
                    "CD4 Naive",
                    "CD4 TCM",
...
# ------------------------------------------------------------------------------
# Redefine T cell clusters which have enough cells for DE analysis
# CD4 proliferating, CD8 Proliferating and dnT no longer a part of this list due to low cell number
t_cell_clusters <-c("CD4 CTL",
                    "CD4 Naive",
                    "CD4 TCM",
                    "CD4 TEM",
