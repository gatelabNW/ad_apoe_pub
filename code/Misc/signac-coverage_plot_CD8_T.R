...
s <- subset(non_cd4, predictedGroupNew == rna_CD8_T)
...
# 1.) Plot CCL5_3 distal region
# Degine range of interest
range_oi <- GRanges(seqnames="chr17", ranges= "35890650-35891150")
...
cov_plot <- CoveragePlot(
  object = s,
  region = GRanges(seqnames = "chr17", ranges="35890650-35891150"),
...
pdf(paste0(output_dir, "CD8_T_cell_", gene,"_3_distal_region", "_diagnosis_covplot.pdf"))
print(cov_plot)
dev.off()

# 2.) Plot CCL5 exonic region
# Degine range of interest
range_oi <- GRanges(seqnames="chr17", ranges= "35880149-35880649")

# Set identity
Idents(s) <- "Diagnosis_APOE"
...
pdf(paste0(output_dir, "CD8_T_cell_", gene,"_exonic_region", "_apoe+diagnosis_covplot.pdf"))
print(cov_plot)
dev.off()
