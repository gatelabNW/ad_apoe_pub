...
output_dir <- "/projects/b1169/projects/AD_APOE/results/de/diagnosis_44/out_NP_09-28-2022_covarSex/"
...
# Subset for APOE
s <- subset(s, APOE_genotype == "E4/E4")
